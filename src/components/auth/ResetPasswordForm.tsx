  ...
  if (submitError) {
    return (
      <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-8 text-center">
        ...
        <h2 className="text-lg font-bold text-[var(--color-text-primary)]">Link inválido o expirado</h2>
  ...
  return (
    <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-8">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="confirmPassword" className="mb-1.5 block text-sm font-medium text-[var(--color-text-secondary)]">
          ...
          {fieldErrors.confirmPassword && (
            <p className="mt-1.5 text-xs text-[var(--color-error)]">{fieldErrors.confirmPassword}</p>
          )}
        </div>
