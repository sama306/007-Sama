  ...
  if (items.length === 0) {
    return (
      <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 text-center">
        ...
        <a
          href="/cart"
          className="mt-4 inline-block rounded-lg bg-[var(--color-accent-primary)] px-6 py-3 text-sm font-semibold text-white"
        >
          Volver al carrito
        </a>
      </div>
    ...
    <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6">
      ...
      >
        {loading ? (
          ...
          <>
            ...
            >
              <path
                d="M41.5 0h-33C3.8 0 0 3.8 0 8.5v3C0 16.2 3.8 20 8.5 20h33c4.7 0 8.5-3.8 8.5-8.5v-3C50 3.8 46.2 0 41.5 0z"
                fill="#635BFF"
              />
              <path
                d="M14 6.5h3.5v7H14v-7zm5.5 0H23l2 4.5 2-4.5h3.5v7h-3v-4.5l-2 4.5h-1l-2-4.5V13.5h-3v-7zm14.5 0h-3v7h3c2.2 0 3.5-1.5 3.5-3.5v-0c0-2-1.3-3.5-3.5-3.5zm0 4.5h0v-2h.5c.8 0 1 .5 1 .8v.4c0 .3-.2.8-1 .8h-.5z"
                fill="white"
              />
            </svg>
            Pagar con Stripe
      ...
      <div className="mt-4 flex items-center justify-center gap-3">
        ...
        >
          ...
          <path
            d="M12.5 7.5h-2l-2.5 6h1.5l.5-1.5h2.5l.5 1.5h1.5l-2-6zm-1.5 3.5l.8-2.5.8 2.5H11zM19 7.5h-1.5l-1.5 6h1.5l1.5-6zM22.5 7.5h-1.5l1.5 6h1.5l-1.5-6zM28.5 9.5c-.5 0-1 .2-1.3.5l-.2-.5h-1.5v6h1.5v-3.5c.3-.3.7-.5 1-.5.5 0 .8.2.8.8v3.2h1.5v-3.5c0-1.2-.8-1.5-1.8-1.5z"
            fill="white"
          />
        </svg>
        <svg
        ...
        >
          ...
          <path
            d="M22.5 10.5c-1.5 0-2.5 1-2.5 2.5s1 2.5 2.5 2.5 2.5-1 2.5-2.5-1-2.5-2.5-2.5zm0 3.8c-.8 0-1.3-.5-1.3-1.3s.5-1.3 1.3-1.3 1.3.5 1.3 1.3-.5 1.3-1.3 1.3zM14 10.5c-1.5 0-2.5 1-2.5 2.5s1 2.5 2.5 2.5 2.5-1 2.5-2.5-1-2.5-2.5-2.5zm0 3.8c-.8 0-1.3-.5-1.3-1.3s.5-1.3 1.3-1.3 1.3.5 1.3 1.3-.5 1.3-1.3 1.3z"
            fill="white"
          />
        </svg>
      </div>
