    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        <div className="mb-6 animate-pulse">
          <svg width="72" height="72" viewBox="0 0 24 24" fill="#ef4444" className="text-[#ef4444]">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
          </svg>
        </div>
        <p className="mb-2 text-lg font-medium text-[var(--color-text-primary)]">
          No agregaste ningún juego a tu lista de deseos todavía
        </p>
            ...
            >
              ...
              <div className="border-t border-[var(--color-border)] p-3">
                <button
                  ...
                  className="w-full rounded-lg border border-[var(--color-border)] px-3 py-2 text-xs font-medium text-[var(--color-error)] transition-colors hover:border-[var(--color-error)] hover:bg-[var(--color-error)]/5"
                >
                  Quitar de favoritos
                </button>
              </div>
